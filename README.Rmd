...
1. **random.pt**: number of random points to be generated **if** using randomForest classification;
1. **Kmeans**:  TRUE/FALSE - if the segmentation must be run with Kmeans analysis or not;
1. **ngroup**: number of classes to be identifyed;
